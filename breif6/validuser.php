<?php
 ...
 $connection = new PDO('mysql:host=localhost;dbname=breif6', $username, $password);
    ...
    $stmt->execute();
    $mysql1=$stmt->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <table class="table table-striped ">
    <thead>
      <tr>
        ...
        <th scope="col">STAES</th>
        <th scope="col">ROLE</th>
      </tr>
    </thead>
    <tbody>
    <?php 
foreach ($mysql1 as $mysql) {
    echo "<tr>";
    echo "<th scope='row'>" . $mysql['user_name'] . "</th>";
    echo "<th scope='row'>" . $mysql['email'] . "</th>";
    if ($mysql['states']  == 1){
        echo "<th scope='row'>" . "VALID" . "</th>";
     }else{
        echo "<th scope='row'>" . "NOT VALID" . "</th>";
     }
    if ($mysql['isadmin'] == 0 && $mysql['states']  == 0){
        echo "<th scope='row'>" . "NOT VALID" . "</th>";

    }
   elseif( $mysql['isadmin'] == 1){
    ...
    // Add other columns as needed, e.g., $mysql['column_name']
    // echo "<th scope='row'>" . $mysql['column_name'] . "</th>";
    echo "</tr>";
}
?>
    </tbody>
