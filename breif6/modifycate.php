...
<div class="container mt-5 border border-primary rounded w-75 p-3 mb-5" style="background-color: rgba(26, 124, 209, 0.481);">
        <h2 class="mb-4 d-flex justify-content-center mt-3">MODIFY A CATEGORY</h2>
        <div class="row justify-content-center">
            <div class="col-md-6">
                <form method="post" action="">
                    ...
                    <div class="form-group">
                        <label for="categoryPicture">NEW Description</label>
                        <input type="text" class="form-control" id="categoryPicture" name="description" required>
                    </div>

                    <div class="form-group">
                        <label for="categoryDescription">NEW Picture URL</label>
                        <input type="text" class="form-control" id="categoryDescription" name="picture" required>
                    </div>

                    <input type="submit"  class="btn btn-primary mt-3 "  style="width: 10rem; margin-left: 35%;" value = "ADD TO LIST">
                </form>
            </div>
        </div>
</div>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-C6RzsynM9kWDrMNeT87bh95OGNyZPhcTNXj1NW7RuBCsyN/o0jlpcV8Qyq46cDfL" crossorigin="anonymous"></script>
        <?php
        // updats dyal kola category
       if ($_SERVER['REQUEST_METHOD'] == "POST") {
        $select = $_POST['selectOptions'];
        $catyname = $_POST['name'];
        $catydescription = $_POST['description'];
        $catypic = $_POST['picture'];

        
            
        $sql = "UPDATE categories
         SET categorie_name = '$catyname' , categorie_description = '$catydescription' ,  categorie_pic = '$catypic'
         WHERE categorie_id = '$select'";
