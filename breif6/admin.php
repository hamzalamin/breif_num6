  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="non.php">VALID</a>
        </li>
        <li class="nav-item">
...
<div class="container mt-5 border border-primary rounded w-75 p-3 mb-5" style="background-color: rgba(26, 124, 209, 0.481);">
        <h2 class="mb-4 d-flex justify-content-center mt-3">ADD A CATEGORY</h2>
            ...
            <div class="col-md-6">
                <form method="post" enctype="multipart/form-data" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="categorydisceiption" name="description" required>
                    </div>

                    <div class="form-group">
                        <label  for="categoryPicture">Picture URL</label>
                        <input type="file"  class="form-control" id="categorypicture" name="picture" required>
                    </div>

                    <input type="submit" name="category" class="btn btn-primary mt-3 "  style="width: 10rem; margin-left: 35%;" value = "ADD TO LIST">
                </form>
            </div>
        </div>
</div>
...
<?php
// code bach kansave data men linputs
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['category'])) {
    $catyname = htmlspecialchars($_POST['name']);
    $catydescription = htmlspecialchars($_POST['description']);
    ...
    $pic_path = $upload_directory . $pic_name;

    if (move_uploaded_file($pic_tmp_name, $pic_path)) {
        $sql = "INSERT INTO categories (categorie_name, categorie_description, categorie_pic) VALUES (?, ?, ?)";
        $stmt = $connection->prepare($sql);
        $stmt->execute([$catyname, $catydescription, $pic_path]);
